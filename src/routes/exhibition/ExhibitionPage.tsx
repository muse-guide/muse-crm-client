                                    ...
                                    <Grid container spacing={3} p={3}>
                                        <Grid xs={12}>
                                            <Stack spacing={1}>
                                                ...
                                                <Typography variant='subtitle2'>Dodaj informacje o kolekcji, które będą dostępne w wybranych przez Ciebie językach. Dodając tutaj języki, definiujesz także w jakich językach będą dostępne eksponaty należące do kolekcji.</Typography>
                                            </Stack>
                                        </Grid>
                                        <Grid xs={12}>
